...
if(!class_exists('WC_Shipping_Method'))
	return;
class PR_Pardakht_Sefareshi_Online_Method extends WC_Shipping_Method
{
	var $w_unit = '';

	public function __construct()
	{
		$this->id = 'pr_pardakht_sefareshi_online';
		$this->method_title = 'پست سفارشی - پرداخت آنلاین';
	...
	public function init_form_fields()
	{
		$this->form_fields = array(
			'enabled' => array(
				...
				'label'     => 'فعال کردن پست سفارشی - پرداخت آنلاین',
				'type'      => 'checkbox',
				'default'   => 'no',
			),
			'title' => array(
				'title'     => 'عنوان روش',
				'type'      => 'text',
				'default'   => 'پست سفارشی - پرداخت آنلاین',
			),
			'min_amount' => array(
