...
if(!class_exists('WC_Shipping_Method'))
	return;
class PR_Pardakht_Pishtaz_COD_Method extends WC_Shipping_Method
{
	var $client = null;

	public function __construct()
	{
		$this->id = 'pr_pardakht_pishtaz_cod';
		$this->method_title = 'پست پیشتاز - پرداخت در محل';
	...
	public function init_form_fields()
	{
		$this->form_fields = array(
			'enabled' => array(
				...
				'label'     => 'فعال کردن پست پیشتاز - پرداخت در محل',
				'type'      => 'checkbox',
				'default'   => 'no',
			),
			'title' => array(
				'title'     => 'عنوان روش',
				'type'      => 'text',
				'default'   => 'پست پیشتاز - پرداخت در محل',
			),
			'min_amount' => array(
