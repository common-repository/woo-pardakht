...
if(!class_exists('WC_Shipping_Method'))
	return;
class PR_Pardakht_Peyk_COD_Method extends WC_Shipping_Method
{
	var $w_unit = '';

	public function __construct()
	{
		$this->id = 'pr_pardakht_peyk_cod';
		$this->method_title = 'پیک - پرداخت در محل';
	...
	public function init_form_fields()
	{
		$this->form_fields = array(
			'enabled' => array(
				...
				'label'     => 'فعال کردن پیک - پرداخت در محل',
				'type'      => 'checkbox',
				'default'   => 'no',
			),
			'title' => array(
